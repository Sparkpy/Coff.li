	...
	<div class="container text-center">
		<div class="row">
			<div class="col-sm">
				...
				<a href="./pricing.php"><img src="./images/beans.webp" alt="Coffee Beans" class="rounded mx-auto d-block img-thumbnail"></a>
			</div>
			<div class="col-sm">
				<div class="text">
			...
			<div class="col-sm">
				...
				<a href="./pricing.php"><img src="./images/cat.jpg" alt="Cat" class="rounded mx-auto d-block img-thumbnail"></a>
			</div>
		</div>
	</div>
</body>
